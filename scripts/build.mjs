...
const campaignNames=['cover-16x9','feature-inspect-16x9','feature-delivery-16x9','feature-developer-16x9'];
const campaignFiles=[...campaignNames.flatMap(name=>[name+'.png',name+'.html']),'campaign-16x9.css','developer-16x9.css','icon.svg','mark.svg'];
...
campaignEntries.push({name:'UIDelta-promo-16x9/marketing/DEVELOPER-HANDOFF-RESEARCH.zh-CN.md',data:await readFile('docs/marketing/DEVELOPER-HANDOFF-RESEARCH.zh-CN.md')});
